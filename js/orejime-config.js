switch(document.documentElement.lang) {
		case "nl":
		  var transapps = {
			  ...
			  'cookie_policy_url':'/nl/cookiebeleid'
		  }			  
		  break;
		case "fr":
		  var transapps = {
			  ...
			  'cookie_policy_url':'/fr/utilisation-de-cookies'
		  }			  
		  break;
		case "en":
		  var transapps = {
			  ...
			  'cookie_policy_url':'/fr/politique-dutilisation-des-cookies'
		  }			  
		  break;
		case "de":
		  var transapps = {
			  ...
			  'cookie_policy_url':'/de/cookie-richtlinie'
		  }			  
		  break;
	}
var orejimeConfig = {
       ...
       nl: {		    
		...
		fr: {			
            ...
            consentNotice: {
                ...
                description: 'Le présent site internet place des cookies. Les cookies essentiels et fonctionnels sont nécessaires au bon fonctionnement du site Internet et ne peuvent pas être refusés. D’autres cookies sont utilisés à des fins statistiques (cookies d’analyse) et ne seront placés que si vous en acceptez le placement. Consultez notre {privacyPolicy} pour en savoir plus.',
                learnMore: 'Paramétrer les cookies'
            },
            save: 'Confirmer mon choix',
            decline: 'Refuser cookies optionnels',
            accept: 'Accepter cookies optionnels',
            acceptAll: 'Accepter tout cookies',
            ...
            consentModal: {
                ...
                description: 'What is a cookie ? What cookies do we use and why? Read all about them in our {privacyPolicy}.',
                privacyPolicy: {
                    name: 'cookie policy',
		...
		de: {
            consentModal: {
                ...
                description: 'Was ist ein Cookie? Welche Cookies verwenden wir und warum? Erfahren Sie mehr in unseren {privacyPolicy}.',
                privacyPolicy: {
